...
- Some videos don't have a description and don't say they have no audio.
...
If you need information on this website in a different format like accessible PDF, large print, easy read, audio recording or braille, email [govuk-brand-team@dsit.gov.uk](mailto:govuk-brand-team@dsit.gov.uk).

We’ll consider your request and get back to you in \[TODO: number\] days.
...
<!--
TODO: If all issues have been fixed, use this sentence instead.
...
1. Some videos don't mention that they have no audio. This makes them inaccessible to users with hearing impairments. This fails WCAG 2.2 success criterion 1.1.1 Non-text Content.

2. Some videos don't have a description. This makes them inaccessible to users with vision impairments. This fails WCAG 2.2 success criterion 1.2.1 Audio-only and Video-only (Prerecorded).

3. Some content looks like headings but is not. This makes it difficult for screen reader users to navigate the page. This fails WCAG 2.2 success criterion 1.3.1 Info and Relationships.
...
This statement was prepared on \[TODO: date when it was first published\]. It was last reviewed on \[TODO: date when it was last reviewed\].

This website was last tested on 30 September 2025 against the WCAG 2.2 AA standard.

<!-- TODO: and re-tested on [date] -->
