...
title: Illustration
landing: true
lead: Quick guides on how to create illustrations, including character designs and layout of a scene and objects.
---
...
{% grid %}
{% gridCell %}
![A circle and a green "start" button separated by a plus sign. Below, an illustration of two women holding a potted plant in a window beside a house with a rain cloud and a tree.](./dotstart.svg)
{% endgridCell %}
{% endgrid %}
...
{% gridCell { classes: 'app-grid__cell--image-full-width' } %}
![A red piggy bank illustration with the text: "Get help with your pension."](./piggy-pension-social.svg)
{% endgridCell %}

{% gridCell { classes: 'app-grid__cell--image-full-width' } %}
![Graphic cards featuring a car, an L-plate, and an ID card icon, with text reading: "Here's how I got my driving licence."](./driving-licence-social.svg)
{% endgridCell %}

{% gridCell { classes: 'app-grid__cell--image-full-width' } %}
![An illustration of a hand holding a UK passport with text reading: "How to apply for a passport."](./apply-passport-social.svg)
{% endgridCell %}

{% gridCell { classes: 'app-grid__cell--image-full-width' } %}
![An approved ID photo layout with a green checkmark, topped with text reading: "Tips for taking a passport photo."](./passport-photo-social.svg)
{% endgridCell %}

{% gridCell { classes: 'app-grid__cell--image-full-width' } %}
![An illustration of a garage mechanic shaking hands with a customer under text reading: "MOT check a vehicle on GOV.UK."](./mot-check-social.svg)
{% endgridCell %}
{% endgrid %}
