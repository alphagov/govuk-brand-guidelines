...
![A real life image of a pair of hands holding a phone, next to it an illustration of the same image.](./objects-real-life.png)
...
![A toolbox with a spanner, a star, and an arrow in the upward trajectory coming out of it.](./objects-narrative.svg)
...
![A calendar page being turned with an X on the page. Next to it, a pair of keys attached to a keychain in the shape of a house.](./objects-standalone.svg)
...
![A ballot box with a hand putting a ballot paper with an X on it into the box.](./objects-perspective.svg)
...
![A row of three buildings: a tall three-story house on the left, a large central building with a gabled roof, and a traditional cottage with a chimney.](./objects-buildings-landscapes.svg)
