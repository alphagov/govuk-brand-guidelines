...
![A screenshot of a GOV.UK browser window displaying community sections titled "Take part in research" and "Attend our events" with accompanying illustrations.](web-illustration-example.png)

### App

![A confirmation screen reading "That's all done!" with a payment reference, shown alongside four service cards featuring icons for keys, a wallet, a calendar, and a passport.](app-illustration-example.png)
