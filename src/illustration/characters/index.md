...
{% figure { src: "./characters-composite-example.svg", alt: "A street scene of different characters. There are 2 women talking, a mother with a pram, a police man, and an elderly man playing basketball", classes: "app-figure__caption--align-left" } %}
{% callout %}
