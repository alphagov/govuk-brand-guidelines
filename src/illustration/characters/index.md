...
{% figure { src: "./characters-composite-example.svg", alt: "A street scene of different characters. There are 2 women talking, a mother with a pram, a police man, and an elderly man playing basketball", classes: "app-figure__caption--align-left app-figure__image-full-width" } %}
{% callout %}
...
![An illustration of deconstructed character parts, including a head, torso, arm, and glasses, arranged within a plastic model kit sprue frame.](./characters-human-design.svg)
...
![A collage of different characters including a female mechanic, a woman wearing a hijab, a man with a beard and a father holding a baby](./characters-representation.svg)
...
{% gridCell { span: 1, classes: "govuk-!-margin-0" } %}
![An illustration of a woman with a circular head and rounded body looking left. She has no discernable facial features.](./characters-facial-features.svg)
{% endgridCell %}

{% gridCell { span: { desktop: 2 }, classes: "govuk-!-margin-bottom-4" } %}
{% callout { classes: "govuk-!-margin-0" } %}
...
![An arm with a circle for the hand showing the width of the arm matching the diameter of the hand.](./characters-arms.svg)
...
![A man in a wheelchair with a dog on their lap and a vet petting the dog.](./characters-body-interaction.svg)
...
![A variety of small and large animals. The butterfly and bee do not have eyes but the larger animals like the elephant, dog and frog do.](./characters-animals.svg)
