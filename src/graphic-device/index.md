...
<video src="./dot-animations.mp4" controls width="720" style="max-width: 100%" class="govuk-!-padding-bottom-6"></video>

{% sectionHighlight {classes: "light-blue" } %}

<p class="govuk-body govuk-!-margin-bottom-0">This video does not contain any audio.</p>
{% endsectionHighlight %}
