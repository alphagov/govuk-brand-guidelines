...
The table below, originally produced by ONS Analysis Function, provides examples of different statistical relationships. It also suggests the [type of chart](https://service-manual.ons.gov.uk/data-visualisation/chart-types) that would work best for a specific example.
